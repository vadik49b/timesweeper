...
export default function Landing(props: Props) {
	...
	const selectedDateKeys = createMemo(() =>
	...
	async function create(
		...
		if (
			...
			setValidationError(
				"Please choose a valid time range (start must be before end).",
			);
	...
	return (
		<div class="landing">
			...
			<form
				class="form-card r"
				onSubmit={create as JSX.EventHandler<HTMLFormElement, SubmitEvent>}
			>
				<div class="field">
				...
				<div class="field">
					<label for="time-start">
						What times might work? ({localTimezone})
					</label>
